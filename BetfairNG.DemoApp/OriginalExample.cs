...
public class OriginalExample
{
    ...
    public void Go()
    {
        ...
        var marketListener = MarketListener.Create(_client, Helpers.HorseRacePriceProjection(), 1);
        ...
        while (_markets.Count > 0)
        {
            ...
            var marketSubscription = marketListener.SubscribeMarketBook(marketCatalogue.MarketId)
                ...
                tick =>
                {
                    Console.WriteLine(Helpers.MarketBookConsole(marketCatalogue, tick, marketCatalogue.Runners));
                },
                () =>
                {
