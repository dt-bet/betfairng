...
namespace BetfairNG
{
    ...
    public class BetfairClient : IBetfairClient
    {
        ...
        public (string, bool) Login(string p12CertificateLocation, string p12CertificatePassword, string username, string password)
        {
        ...
        public Task<BetfairServerResponse<PlaceExecutionReport>> PlaceOrders(
            ...
            string customeStrategyReference = null)
        {
            var args = new Dictionary<string, object>();
            ...
            args[CUSTOMER_STRATEGY_REFERENCE] = customeStrategyReference;
    ...
    public class BetfairServerException : System.Exception
    {
        ...
        public static BetfairServerException ToClientException(API.Exceptions.Exception ex)
        {
            if (ex == null)
                return null;
